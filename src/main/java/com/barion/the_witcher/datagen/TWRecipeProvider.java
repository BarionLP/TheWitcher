...
public class TWRecipeProvider extends ExtendedRecipeProvider {
    public TWRecipeProvider(PackOutput output) {super(output, TheWitcher.ModID);}

    @Override
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        oreSmelting(consumer, TWItems.SilverIngot.get(), TWItems.RawSilver.get());
        nineBlockStorage(consumer, RecipeCategory.MISC, TWItems.SilverIngot.get(), TWBlocks.SilverBlock.get());
        nineBlockStorage(consumer, RecipeCategory.MISC, TWItems.SilverNugget.get(), TWItems.SilverIngot.get());
        nineBlockStorage(consumer, RecipeCategory.MISC, TWItems.RawSilver.get(), TWBlocks.RawSilverBlock.get());
        nineBlockStorage(consumer, RecipeCategory.MISC, TWItems.SteelNugget.get(), TWItems.SteelIngot.get());

        {ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, TWItems.SilverSword.get())
        ...
        shapeless(consumer, RecipeCategory.BUILDING_BLOCKS, TWBlocks.FrostedStone.get(), 4, TWBlocks.FrostedCobblestone.get(), 4);
        shapeless(consumer, RecipeCategory.BUILDING_BLOCKS, TWBlocks.DeepFrostedStone.get(), 4, TWBlocks.DeepFrostedCobblestone.get(), 4);

        float xp = 0.1f;
        int time = 200;

        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.COBBLESTONE, TWBlocks.FrostedCobblestone.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.COBBLESTONE_STAIRS, TWBlocks.FrostedCobblestoneStairs.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.COBBLESTONE_SLAB, TWBlocks.FrostedCobblestoneSlab.get(), xp/2, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.COBBLESTONE_WALL, TWBlocks.FrostedCobblestoneWall.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE, TWBlocks.FrostedStone.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE_STAIRS, TWBlocks.FrostedStoneStairs.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE_SLAB, TWBlocks.FrostedStoneSlab.get(), xp/2, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE_BUTTON, TWBlocks.FrostedStoneButton.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE_BRICKS, TWBlocks.FrostedStoneBricks.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE_BRICK_STAIRS, TWBlocks.FrostedStoneBrickStairs.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE_BRICK_SLAB, TWBlocks.FrostedStoneBrickSlab.get(), xp/2, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.STONE_BRICK_WALL, TWBlocks.FrostedStoneBrickWall.get(), xp, time);
        smelting(consumer, RecipeCategory.BUILDING_BLOCKS, Items.CRACKED_STONE_BRICKS, TWBlocks.CrackedFrostedStoneBricks.get(), xp, time);
        ...
        smelting(consumer, RecipeCategory.FOOD, TWItems.HotWaterBottle.get(), Items.POTION, 0.1f, 200);
