...
public class TWRecipes extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        recipeFurnance(TWBlocks.DeepFrostedCobblestone.get(), Items.COBBLESTONE, 0, 400, "_from_deep_frosted_cobblestone");
        recipeFurnance(TWBlocks.DeepFrostedStone.get(), Items.STONE, 0, 400, "_from_deep_frosted_stone");
    }
    ...
    protected void recipeOreSmelting(ItemLike ingredient, ItemLike result) {
        recipeFurnance(ingredient, result, 0.7f, 200, "_smelting");
    ...
    protected void recipeSword(Tag.Named<Item> material, ItemLike sword){
