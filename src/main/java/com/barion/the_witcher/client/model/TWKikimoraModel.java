...
public class TWKikimoraModel extends AdvancedEntityModel<TWKikimora> {
	...
	public TWKikimoraModel() {
		texHeight = 128;
		textureWidth = 200;

		Root = new AdvancedModelBox(this, "Root");
		setRotateAngle(Root, 0, 3.14159f, 0);
		Root.offsetY = 24;

		Body = new AdvancedModelBox(this, "Body").setTextureOffset(0, 37);
		//Root.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 37).addBox(-9.0F, -9.0377F, 21.2437F, 18.0F, 16.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -25.9623F, -21.2437F)
		Root.addChild(Body);
		Body.addBox(-9, -9, 21, 18, 16, 18, false);
	}
	...
	@Override
	public void setupAnim(TWKikimora entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
