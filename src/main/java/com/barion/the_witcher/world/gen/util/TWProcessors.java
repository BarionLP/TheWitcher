...
public class TWProcessors {
    ...
    public static final RandomBlockSwapProcessor CrackFrostedStoneBrickStairs = new RandomBlockSwapProcessor(TWBlocks.FrostedStoneBrickStairs.get(), 0.05f, TWBlocks.CrackedFrostedStoneBrickStairs.get());
    public static final RandomBlockSwapProcessor CrackFrostedStoneBrickSlab = new RandomBlockSwapProcessor(TWBlocks.FrostedStoneBrickSlab.get(), 0.05f, TWBlocks.CrackedFrostedStoneBrickSlab.get());
    public static final RandomBlockSwapProcessor CrackFrostedStoneBrickWall = new RandomBlockSwapProcessor(TWBlocks.FrostedStoneBrickWall.get(), 0.05f, TWBlocks.CrackedFrostedStoneBrickWall.get());
