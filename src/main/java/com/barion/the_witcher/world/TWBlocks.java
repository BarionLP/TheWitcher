...
public class TWBlocks {
    ...
    public static final RegistryObject<StoneButtonBlock> FrostedCobblestoneButton = register("frosted_cobblestone_button", () -> new StoneButtonBlock(frostedNoCollision));
    ...
    public static final RegistryObject<StoneButtonBlock> FrostedStoneButton = register("frosted_stone_button", () -> new StoneButtonBlock(frostedNoCollision));
    ...
    public static final RegistryObject<StoneButtonBlock> CrackedFrostedStoneBrickButton = register("cracked_frosted_stone_brick_button", () -> new StoneButtonBlock(frostedNoCollision));
    ...
    public static final RegistryObject<StoneButtonBlock> DeepFrostedCobblestoneButton = register("deep_frosted_cobblestone_button", () -> new StoneButtonBlock(deepFrostedNoCollision));
    ...
    public static final RegistryObject<StoneButtonBlock> DeepFrostedStoneButton = register("deep_frosted_stone_button", () -> new StoneButtonBlock(deepFrostedNoCollision));
    ...
    public static final RegistryObject<Block> CrackedDeepFrostedStoneBricks = register("cracked_deep_frosted_stone_bricks", block(deepFrosted));
    public static final RegistryObject<StairBlock> CrackedDeepFrostedStoneBrickStairs = register("cracked_deep_frosted_stone_brick_stairs", stair(deepFrosted, () -> CrackedDeepFrostedStoneBricks.get().defaultBlockState()));
    public static final RegistryObject<SlabBlock> CrackedDeepFrostedStoneBrickSlab = register("cracked_deep_frosted_stone_brick_slab", slab(deepFrosted));
    public static final RegistryObject<WallBlock> CrackedDeepFrostedStoneBrickWall = register("cracked_deep_frosted_stone_brick_wall", wall(deepFrosted));
    public static final RegistryObject<StoneButtonBlock> CrackedDeepFrostedStoneBrickButton = register("cracked_deep_frosted_stone_brick_button", () -> new StoneButtonBlock(deepFrostedNoCollision));
    ...
    public static final RegistryObject<StoneButtonBlock> DeepFrostedStoneTileButton = register("deep_frosted_stone_tile_button", () -> new StoneButtonBlock(deepFrostedNoCollision));
    public static final RegistryObject<Block> CrackedDeepFrostedStoneTiles = register("cracked_deep_frosted_stone_tiles", block(deepFrosted));
    public static final RegistryObject<StairBlock> CrackedDeepFrostedStoneTileStairs = register("cracked_deep_frosted_stone_tile_stairs", stair(deepFrosted, () -> CrackedDeepFrostedStoneTiles.get().defaultBlockState()));
    public static final RegistryObject<SlabBlock> CrackedDeepFrostedStoneTileSlab = register("cracked_deep_frosted_stone_tile_slab", slab(deepFrosted));
    public static final RegistryObject<WallBlock> CrackedDeepFrostedStoneTileWall = register("cracked_deep_frosted_stone_tile_wall", wall(deepFrosted));
