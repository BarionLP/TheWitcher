...
public class TWMasterSmithingMenu extends AbstractContainerMenu {
    ...
    protected boolean mayPickup(Player player, boolean hasItem) {
        return this.selectedRecipe != null && selectedRecipe.matches(getContainer(), level);
    }

    public void createResult() {
        List<TWMasterSmithingRecipe> list = level.getRecipeManager().getRecipesFor(TWMasterSmithingRecipe.Type.Instance, getContainer(), level);
        if (list.isEmpty()) {
