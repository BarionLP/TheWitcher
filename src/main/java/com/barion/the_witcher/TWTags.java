...
public class TWTags {
    public static final class Blocks{
        public static final TagKey<Block> SilverOres = forge("ores/silver");
        ...
        private static TagKey<Block> mod(String path){return BlockTags.create(new ResourceLocation(TheWitcher.ModID, path));}
    }

    public static final class Items{
        public static final TagKey<Item> SilverOres = forge("ores/silver");
        ...
        private static TagKey<Item> mod(String path){
            return ItemTags.create(new ResourceLocation(TheWitcher.ModID, path));
        }
    }
    ...
    public static final class Entities{
        ...
        private static TagKey<EntityType<?>> forge(String path){
            return create(new ResourceLocation("forge", path));
        }
        private static TagKey<EntityType<?>> mod(String path){
            return create(new ResourceLocation(TheWitcher.ModID, path));
        }
